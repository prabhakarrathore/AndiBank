    ...
    <div class="section-title">
        ...
        ${Object.keys(item)
            ...
            .map((key, index) => {
                ...
                const heading = item[key] || ""; // Ensure heading is not undefined
                const text = item[textKey] || ""; // Ensure text is not undefined
                const img = item[imgKey] ? `<img class="content-image" src="${item[imgKey]}" alt="image" loading="lazy">` : "";

                return `
                <div class="page content-container" style="background-color: ${backgroundColor};">
                    <!-- Left: Image -->
